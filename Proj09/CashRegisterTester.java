...
public class CashRegisterTester
{
   public static void main(String[] args)
   {
      ...
      System.out.println("\nTRANSACTION 1"); 
      double[] transaction1 = register.addTransaction(25.75, 10.50);
      System.out.println("Payment: " + transaction1[0]);
      System.out.println("Purchase: " + transaction1[1]);
      System.out.println("Change: " + transaction1[2]); 
   }
}
