    ...
    public void start(Stage primaryStage) { 
        ...
        class OKHandlerClass implements EventHandler<ActionEvent> { 
            ...
            public void handle(ActionEvent e) { 
                System.out.println("HandleEventWInnerClass: OK button clicked");
            } 
        }
        ...
        class CancelHandlerClass implements EventHandler<ActionEvent> { 
            @Override
            public void handle(ActionEvent e) { 
                System.out.println("HandleEventWInnerClass: Cancel button clicked");
            }
        }        
        ...
        primaryStage.setTitle("HandleEventWInnerClass"); // Set the stage title
